...
let ans='';
const MediaSlide=({idx,updatedHeight,updatedWidth,content})=>{
        ...
        ans=elements.map((key,index)=>{
            if(key.type=='text'){
                ...
                alignItems: 'center',borderStyle:'double' ,borderColor:'black'}} key={index}>
                    ...
                    <TextField sx={{height:'30%',width:'40%',paddingTop:'-20%'}} minRows='3' onChange={(event)=>onChangeHandler(event,index,1)} placeholder='paragrph'>{key.contentPara}</TextField>
